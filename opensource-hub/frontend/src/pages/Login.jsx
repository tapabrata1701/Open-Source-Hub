    ...
    <div className="min-h-screen flex items-center justify-center p-6 relative">
      ...
      >
        ...
        <div className="mb-8">
          ...
          >
            <ArrowRight size={20} className="text-accent-neon group-hover:scale-110 transition-transform" />
            Log in with GitHub
          </a>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-text-dim mb-4">New here? <Link to="/signup" className="text-accent-neon hover:underline">Create an account</Link></p>
            <motion.button 
